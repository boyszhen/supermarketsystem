            ...
            <div class="text item">
                <el-form :model="accountNum" status-icon :rules="rules" ref="accountNum" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="用户名" prop="user">
                        <el-input type="password" v-model="accountNum.user" autocomplete="off"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="用户组" prop="group">
                        <el-select v-model="sizeForm.region" placeholder="请选择用户组">
                            <el-option label="普通用户" value="group1"></el-option>
                            <el-option label="高级用户" value="group2"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item>
